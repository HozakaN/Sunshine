package com.hozakan.android.sunshine.sync;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        doSync();
        if (Utility.areNotificationsActivated(getContext())) {
            notifyWeather();
        }
    }
...
//        if (true) {
            ...
            if (cursor.moveToFirst()) {
                ...
                notifyWeather(title, contentText, iconId);
    ...
    private void notifyWeather(String title, String contentText, int iconId) {
...
// Creates an explicit intent for an Activity in your app
        Intent resultIntent = DetailActivity.createIntent(getContext(), System.currentTimeMillis());
...
// mId allows you to update the notification later on.
    ...
    private void doSync() {// If there's no zip code, there's nothing to look up.  Verify size of params.
...
//        WeatherContract.LocationEntry.
        ...
        Cursor cursor = getContext().getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI, new String[] {WeatherContract.LocationEntry._ID}, selection, selectionArgs, null);
        long locationId;
        if (cursor.moveToFirst()) {
            ContentValues cv = new ContentValues();
            ...
            locationId = ContentUris.parseId(
                    getContext().getContentResolver().insert(
                            WeatherContract.LocationEntry.CONTENT_URI,
                            WeatherContract.LocationEntry.createContentValues(locationSetting, cityName, lat, lon)));
        }
        return locationId;
    } /**
