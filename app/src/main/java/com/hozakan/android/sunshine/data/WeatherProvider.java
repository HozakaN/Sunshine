...
public class WeatherProvider extends ContentProvider {
    ...
    private Cursor getLocation(String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        Cursor cursor = mOpenHelper.getReadableDatabase().query(
                WeatherContract.LocationEntry.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
        return cursor;
    }
...
//        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case WEATHER:
                nbRowDeleted = db.delete(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case LOCATION:
                nbRowDeleted = db.delete(WeatherContract.LocationEntry.TABLE_NAME, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
