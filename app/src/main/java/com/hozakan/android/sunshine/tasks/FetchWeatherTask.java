...
/**
 * Created by gimbert on 15-06-15.
 */
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private static final int DAYS_PARAM_VALUE= 7;

    public interface FetchWeatherTaskCallback {
        void onWeatherTaskEnded(String[] forecast);
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            .appendQueryParameter(DAYS_PARAM, Integer.toString(DAYS_PARAM_VALUE))
            .build();
//            URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=94043&mode=json&units=metric&cnt=7");
            ...
            return getWeatherDataFromJson(forecastJsonStr, DAYS_PARAM_VALUE);
        } catch (IOException e) {
    ...
    protected void onPostExecute(String[] strings) {
        super.onPostExecute(strings);
            if (mCallback.get() != null) {
                if (strings != null) {
                    mCallback.get().onWeatherTaskEnded(strings);
                } else {
                    mCallback.get().onWeatherTaskError();
            }
        }
    }
