 ...
 */
package com.hozakan.android.sunshine.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    private long insertLocation() {
        ...
        Assert.assertTrue("Error : no row returned", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Entered values are not the good ones", cursor, cv);

        Assert.assertFalse("Error : more than one row returned", cursor.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        // Move the cursor to a valid database row
        Assert.assertTrue("There should be one entry in this cursor", cursor.moveToFirst());
        ...
        Assert.assertFalse("There should be not more than one entry in this cursor", cursor.moveToNext());
